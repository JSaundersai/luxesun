...
const subCategoryImages: Record<string, string> = {
  Sleeves: "/placeholders/products/baseline-sleeves-front.jpg",
  "Crop Tops": "/placeholders/products/ace-crop-front.jpg",
  Shirts: "/placeholders/products/horizon-shirt-front.jpg",
  "Base Layers": "/placeholders/products/baselayer-short-front.jpg",
  "Beach Volleyball": "/placeholders/products/ace-crop-front.jpg",
  Running: "/placeholders/products/rally-crop-front.jpg",
  "Tennis & Golf": "/placeholders/products/serve-shirt-front.jpg",
};
...
export default function CollectionPage() {
  ...
  if (!collection) {
    return (
      <PageLayout>
        <div className="px-6 py-32 min-h-[50vh]">
          <div className="max-w-[1400px] mx-auto text-center">
            <h1 className="font-serif text-4xl mb-4">Collection Not Found</h1>
            <Link href="/collections" className="text-terracotta underline">
  ...
  const baseProducts = products.filter(collection.filter);
  ...
  return (
    <PageLayout>
                ...
                <div className="flex flex-wrap gap-4 md:gap-5 md:pt-4">
                  {collection.subCategories.map((sub) => (
                    ...
                    >
                      ...
                      <span
                        className={`font-sans text-[0.6rem] md:text-[0.7rem] font-medium tracking-[0.08em] uppercase text-center transition-colors max-w-[80px] leading-tight ${
                          activeSubCategory === sub
                            ? "text-terracotta"
      ...
      {/* Products */}
      <section className="px-6 py-12 bg-ivory border-t border-border-cream min-h-[40vh]">
        <div className="max-w-[1400px] mx-auto">
          <FadeIn className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-4">
              <h2 className="section-title">
                ...
                {filteredProducts.length === 1 ? "style" : "styles"} found
              </h2>
              {activeSubCategory && (
                <button
          ...
          {filteredProducts.length > 0 ? (
            ...
            <p className="text-center text-stone-gray font-sans">

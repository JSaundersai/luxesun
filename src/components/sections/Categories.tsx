            ...
            >
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 text-ivory sm:p-8 md:p-9">
                  ...
                  <span className="inline-flex min-h-[48px] items-center gap-3 rounded-full bg-ivory px-6 py-3 font-sans text-[0.8rem] font-medium uppercase tracking-[0.14em] text-near-black transition-all duration-300 group-hover:gap-4">
                    Shop now
                    <svg
                      className="h-4 w-4"
                      fill="none"
